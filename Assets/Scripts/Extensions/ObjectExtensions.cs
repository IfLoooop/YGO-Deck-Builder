...
namespace YGODeckBuilder.Extensions
{
    ...
    internal static class ObjectExtensions
    {
        ...
        internal static string Bold(this object? _Object)
        {
        ...
        internal static string Italic(this object? _Object)
        {
        ...
        internal static string Color(this object? _Object, RichTextColor _Color)
        {
        ...
        internal static string OrNull(this object? _Object)
        {
        ...
        internal static MemoryStream ToMemoryStream(this object? _Object, Encoding _Encoding)
        {
